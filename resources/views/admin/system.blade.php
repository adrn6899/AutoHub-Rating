...
@section('content')
<div class="system-index" style="border: 1px solid green">
    <div class="row" style="max-height: 100%">
        ...
        <div class="col">
            <button class="btn btn-success btn-add btn-lg mt-2" data-bs-toggle="modal" data-bs-target="#systemModal">Add</button>
        </div>
    </div>
    <div class="admin-body-container">
        <table class="table table-light table-bordered" id="systemsTable" style="width:100%">
