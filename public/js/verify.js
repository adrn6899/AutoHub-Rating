    ...
    function createAnswerField(){
        $.each(questions.questions, function(key,value){
            $('.container-fluid', function(){
                $('.q-list2').append('<div class="rating-div col-md-12" id="'+value.id+'"><label style="font-size:1.5rem;"  id="'+value.id+'">'+value.title+'</label></br><div class="rating-'+key+' starsRating" style="font-size: 4rem;"></div></div><hr class="dashed">');
